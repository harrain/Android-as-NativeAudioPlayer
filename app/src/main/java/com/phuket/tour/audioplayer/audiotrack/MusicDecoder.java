...
public class MusicDecoder implements Mp3Decoder {
	...
	public native int getMusicMeta(String musicPath, int[] metaArray);
	/** 最开始init的时候进行打开伴奏文件 **/
	public native int openFile(String accompanyPath, float packetBufferTimePercent);
	/** 打开文件之后进行读取samples处理 **/
	public native int readSamples(short[] samples, int size, int[] slientSizeArr);
	/** 最终当歌曲结束的时候 关闭文件  **/
